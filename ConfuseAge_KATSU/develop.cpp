    ...
    try {
        ...
        while (running) {
            ...
            if (country_key == 224) {
                ...
                json Element = CastleData[position];
                string Castle_Name = Element["castle_name"];
                cout << Castle_Name << "병사를 모집할 사람을 임명해주세요!" << endl;
            ...
            if (country_key == 224) {
                ...
                while (general_running) {
                    ...
                    else if (general_key == 13)
                    {
                        ...
                        system("cls");
                        cout << "병력 모집 시에는 자금 1000원이 소모됩니다!" << endl;
                        cout << "개발 하시겠습니까?" << endl;
                        cout << "예 -> Y , 아니오 -> N" << endl;
                        cin >> army_num;
                    ...
                    system("cls");
                    int general_count = 0;
                    cout << Castle_Name << "병력을 모집할 사람을 임명해주세요!" << endl;
                    for (const auto& entry : HouseData) {
                        if (entry["House"] == "Hatakeyama") {
                            for (const auto& general : entry["General_List"]) {
                                for (const auto& GeneralEntry : GeneralData) {
